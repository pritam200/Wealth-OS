...
@Component
@Order(1)
public class AxisBankParser implements EmailParser {
    ...
    public boolean canParse(String from, String subject) {
        boolean fromAxis = ParserUtil.containsIgnoreCase(from, "axisbank", "axis bank");
    ...
    public List<ParsedEmail> parse(String from, String subject, String bodyText) {
        ...
        if (isRd) {
            ...
            results.add(ParsedEmail.builder()
                ...
                .sourceDescription(String.format("Axis RD: ₹%.0f/month", monthly))
                .build());
        } else {
            ...
            results.add(ParsedEmail.builder()
                ...
                .sourceDescription(String.format("Axis FD: ₹%.0f%s", amount, rateStr != null ? " @ " + rateStr + "%" : ""))
                .build());
        }
        return results;
    }
