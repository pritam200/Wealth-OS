...
@Component
@Order(1)
public class IdfcBankParser implements EmailParser {
    ...
    public boolean canParse(String from, String subject) {
        boolean fromIdfc = ParserUtil.containsIgnoreCase(from, "idfcfirstbank", "idfc first", "idfc bank");
    ...
    public List<ParsedEmail> parse(String from, String subject, String bodyText) {
        ...
        if (isRd) {
            ...
            results.add(ParsedEmail.builder()
                ...
                .sourceDescription(String.format("IDFC FIRST RD: ₹%.0f/month", monthly))
                .build());
        } else {
            ...
            results.add(ParsedEmail.builder()
                ...
                .sourceDescription(String.format("IDFC FIRST FD: ₹%.0f%s", amount, rateStr != null ? " @ " + rateStr + "%" : ""))
                .build());
        }
        return results;
    }
