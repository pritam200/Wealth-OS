...
@Component
@Order(1)
public class YesBankParser implements EmailParser {
    ...
    public boolean canParse(String from, String subject) {
        boolean fromYes = ParserUtil.containsIgnoreCase(from, "yesbank", "yes bank");
    ...
    public List<ParsedEmail> parse(String from, String subject, String bodyText) {
        ...
        if (isRd) {
            ...
            results.add(ParsedEmail.builder()
                ...
                .sourceDescription(String.format("Yes Bank RD: ₹%.0f/month", monthly))
                .build());
        } else {
            ...
            results.add(ParsedEmail.builder()
                ...
                .sourceDescription(String.format("Yes Bank FD: ₹%.0f%s", amount, rateStr != null ? " @ " + rateStr + "%" : ""))
                .build());
        }
        return results;
    }
